...
class UserFollowedPage extends Component {
    constructor(props) {
        super(props)
                ...
                <article className="main-article-shared-content">
                    <section className="friend-content-section">
                        <div className="container col-md-12 text-center mb-5">
                            <h1 className="text-center font-weight-bold mt-4" style={{ 'margin': '1rem auto' }}>Followed Users</h1>
                            ...
                            <section className="friend-section" >
                                {this.props.friendsArr.length > 0 ?
                                    ...
                                    :
                                    (<Fragment>
                                            <h2>You haven't followed anyone. Find some!</h2>
                                            {
                                                isTheCurrentLoggedInUser ?
...
export default connect(mapStateToProps, mapDispatchToProps)(UserFollowedPage);