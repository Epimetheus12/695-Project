...
import FriendsGallery from './FriendGallery';
...
const UserEditPage = lazy(() => import('../../components/userPage/UserEditPage'));
/*const UserDeletePage = lazy(() => import('../../components/user/UserDeletePage'));*/
const UserGalleryPage = lazy(() => import('../userPage/UserGalleryPage'));
                ...
                <main className="site-content">
                    <section className="main-section">
                        ...
                        <Suspense fallback={
                            ...
                            <Switch>
                                {loggedIn && <Route exact path="/home/comments/:id" component={SharedContent} />}
