...
function addPicturesAction(data, timeLineUserId) {
    return (dispatch) => {
        ...
        return requester.addPhoto('/api/picture/add', data, (response) => {
            if (response.error) {
...
function removePictureAction(loggedInUserId, photoToRemoveId, timeLineUserId) {
    ...
    return (dispatch) => {
        ...
        return requester.post('/api/picture/remove', requestBody, (response) => {
            if (response.error) {
                const { error, message, status, path } = response;
...
function fetchPicturesAction(userId) {
    return (dispatch) => {
        ...
        return requester.get('/api/picture/all/' + userId, (response) => {
            if (response.error) {
                const { error, message, status, path } = response;
