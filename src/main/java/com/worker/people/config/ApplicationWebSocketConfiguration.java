package com.worker.people.config;
...
import com.worker.people.websocket.JWTAuthenticationToken;
...
import static com.worker.people.utils.messages.ResponseMessage.UNAUTHORIZED_SERVER_ERROR_MESSAGE;
...
public class ApplicationWebSocketConfiguration implements WebSocketMessageBrokerConfigurer {
    ...
    @Autowired
    public ApplicationWebSocketConfiguration(UserService userService, UserValidation userValidation) {
