...
import com.worker.people.filters.JwtAuthenticationFilter;
import com.worker.people.filters.JwtAuthorizationFilter;
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http
                ...
                .antMatchers(
                        ...
                        "/message/friend",
                        "/socket/**"
                ).permitAll()/*hasAnyAuthority("ADMIN", "ROOT", "USER")*/
                .antMatchers(
                        "/users/promote",
                        "/users/demote",
                        "/users/all/*",
